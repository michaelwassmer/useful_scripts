...
rootplot rootplot_config.py test.root M_W_DM_Mphi_2000_Mchi_500 M_W_DM_Mphi_1995_Mchi_1000 M_W_DM_Mphi_2000_Mchi_1500 --size=1024x768 --ylabel="arbitrary units" --legend-location='upper right' --gridx --gridy -e pdf --output="test" --noclean --title="M_{#phi}=2000 GeV" --legend-entries="M_{#phi}|M_{#chi}=2000|500 GeV,M_{#phi}|M_{#chi}=2000|1000 GeV,M_{#phi}|M_{#chi}=2000|1500 GeV" --title=' '
mv test/plot.pdf test/M_W_DM_Mphi_2000.pdf
...
rootplot rootplot_config.py test.root M_W_DM_Mphi_3000_Mchi_1000 M_W_DM_Mphi_2995_Mchi_1500 M_W_DM_Mphi_3000_Mchi_2000 --size=1024x768 --ylabel="arbitrary units" --legend-location='upper right' --gridx --gridy -e pdf --output="test" --noclean --title="M_{#phi}=3000 GeV" --legend-entries="M_{#phi}|M_{#chi}=3000|1000 GeV,M_{#phi}|M_{#chi}=3000|1500 GeV,M_{#phi}|M_{#chi}=3000|2000 GeV" --title=' '
mv test/plot.pdf test/M_W_DM_Mphi_3000.pdf
...
rootplot rootplot_config.py test.root M_W_DM_Mphi_200_Mchi_50 M_W_DM_Mphi_2000_Mchi_500 M_W_DM_Mphi_3000_Mchi_1000 --size=1024x768 --ylabel="arbitrary units" --legend-location='upper right' --gridx --gridy -e pdf --output="test" --noclean --title="M_{#phi}>2#upoint M_{#chi}" --legend-entries="M_{#phi}|M_{#chi}=200|50 GeV,M_{#phi}|M_{#chi}=2000|500 GeV,M_{#phi}|M_{#chi}=3000|1000 GeV"
...
rootplot rootplot_config.py test.root M_W_DM_Mphi_195_Mchi_100 M_W_DM_Mphi_1995_Mchi_1000 M_W_DM_Mphi_2995_Mchi_1500 --size=1024x768 --ylabel="arbitrary units" --legend-location='upper right' --gridx --gridy -e pdf --output="test" --noclean --title="M_{#phi}=2#upoint M_{#chi}" --legend-entries="M_{#phi}|M_{#chi}=200|100 GeV,M_{#phi}|M_{#chi}=2000|1000 GeV,M_{#phi}|M_{#chi}=3000|1500 GeV"
...
rootplot rootplot_config.py test.root M_W_DM_Mphi_200_Mchi_150 M_W_DM_Mphi_2000_Mchi_1500 M_W_DM_Mphi_3000_Mchi_2000 --size=1024x768 --ylabel="arbitrary units" --legend-location='upper right' --gridx --gridy -e pdf --output="test" --noclean --title="M_{#phi}<2#upoint M_{#chi}" --legend-entries="M_{#phi}|M_{#chi}=200|150 GeV,M_{#phi}|M_{#chi}=2000|1500 GeV,M_{#phi}|M_{#chi}=3000|2000 GeV"
