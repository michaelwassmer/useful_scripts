...
usage += "This script takes a root file containing histograms and calculates transfer factors."
parser = OptionParser(usage=usage)

parser.add_option(
    "--signal_processes",
    action="append",
    dest="signal_processes",
    help="identifier for the signal processes",
    default=[]
)
...
parser.add_option(
    ...
    action="append",
    dest="background_processes",
    help="identifier for the background processes",
    default=[]
)
...
parser.add_option(
    ...
    action="append",
    dest="signal_regions",
    help="identifier for the signal region",
    default=[],
)
...
parser.add_option(
    "--background_regions",
    action="append",
    dest="background_regions",
    help="identifier for the background regions",
    default=[]
)
...
parser.add_option(
    ...
    action="store",
    dest="variable",
    help="variable name of the histograms",
...
output_file = ROOT.TFile(
    input_file.GetName().replace(".root", "") + "_TFs.root", "RECREATE"
)
...
for i in range(len(options.signal_processes)):
    ...
    transfer_factors_nominal_name = "TF" + "_" + background_process + "_" + background_region + "_" + signal_process + "_" + signal_region + "_" + variable
